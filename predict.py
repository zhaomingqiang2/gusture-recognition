...
def Initializer():
    ...
    data, label = utils.shuffle(immatrix, label)
...
def inference(input_tensor, train, regularizer):
    ...
    #a1=tf.convert_to_tensor(np.array(pool4))
    print('zhaomingqiang',pool_shape[0])
